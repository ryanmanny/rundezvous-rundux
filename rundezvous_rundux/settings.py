"""
Django settings for rundezvous_rundux project.
...
SECRET_KEY = '8mvacv)u&d@zj+tiwiy+!y$t)v8mzya3y#esnpnzy1t@pk@r*m'
...
WSGI_APPLICATION = 'rundezvous_rundux.wsgi.application'
