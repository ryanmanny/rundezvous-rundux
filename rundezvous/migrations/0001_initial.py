# Generated by Django 2.2 on 2019-05-26 05:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_updated_at', models.DateTimeField(auto_now_add=True, db_index=True, null=True)),
                ('rundezvous_status', models.CharField(choices=[('N', 'None'), ('L', 'Looking'), ('R', 'Running'), ('V', 'Review')], default='N', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chatroom', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='rundezvous.Chatroom')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='rundezvous.Chatroom')),
